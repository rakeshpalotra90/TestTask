...
import BrightnessControllScreen from './BrightnessControllSreen';
import FocusControllScreen from './FocusControlScreen';

export const HOME_SCREEN = 'HomeScreen';
export const NETWORK_CONTROL_SCREEN = 'NetworkControlScreen';
export const MUSIC_CONTROL_SCREEN = 'MusicControlScreen';
export const BRIGHTNESS_CONTROL_SCREEN = 'BrightnessControllScreen';
export const FOCUS_CONTROL_SCREEN = 'FocusControllScreen';
...
Screens.set(BRIGHTNESS_CONTROL_SCREEN, BrightnessControllScreen);
Screens.set(FOCUS_CONTROL_SCREEN, FocusControllScreen);
