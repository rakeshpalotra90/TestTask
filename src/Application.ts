...
export default class Application {
  ...
  navigateBrightnessControl(componentId: string) {
    Navigation.showOverlay({
      component: {
        name: BRIGHTNESS_CONTROL_SCREEN,
      },
    });
  }

  navigateFocusControl(componentId: string) {
    Navigation.showOverlay({
      component: {
        name: FOCUS_CONTROL_SCREEN,
      },
    });
  }
