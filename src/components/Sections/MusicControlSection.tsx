...
/**
 * MusicControlSection - Screen is used to display block of play, pause, backward and forward controls
 **/
export default class MusicControlSection extends React.Component<Props> {
  ...
  render() {
    ...
    const animatedStyle: any = {transform: [{scale: this.animatedScaleValue}]};
